...
- `sample_bottom_modeline.gcode` — tests modeline parsing at the bottom of files
- `sample_prusa.gcode` — real Prusa printer output for integration testing and
  benchmarking
...
2. Include a comment header explaining what the fixture tests.
